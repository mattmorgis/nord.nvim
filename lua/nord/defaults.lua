...
function defaluts.highlights()
  ...
  return {
    ...
    StatusLine = { fg = c.snow_storm.origin, bg = c.polar_night.bright }, -- status line of current window
    ...
    StatusLineGit = { fg = c.frost.ice, bg = c.polar_night.brighter },
    User1 = { fg = c.aurora.red, bg = c.polar_night.bright, bold = true },
    User2 = { fg = c.frost.ice, bg = c.polar_night.bright, bold = true },
    User3 = { fg = c.snow_storm.origin, bg = c.polar_night.bright, bold = true },
    User4 = { fg = c.polar_night.origin, bg = c.aurora.yellow },
    User5 = { fg = c.aurora.red, bg = c.polar_night.bright },
    User6 = { fg = c.aurora.yellow, bg = c.polar_night.bright },
